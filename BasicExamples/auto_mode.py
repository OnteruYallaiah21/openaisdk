...
def input_with_fallback(prompt: str, fallback: str) -> str:
    print(f"[DEBUG] Checking auto mode for input fron inputwith: '{prompt.strip()}' with fallback: '{fallback}'")
...
if __name__ == "__main__":
    # Example usage
    name = input_with_fallback("What is your name? ", "Alice")
    print(f"Hello, {name}!")

    if confirm_with_fallback("Do you want to continue? ", default=True):
        print("Continuing...")
    else:
        print("Exiting...")